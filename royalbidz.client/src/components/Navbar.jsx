      ...
      <div className="navbar-container">
        ...
        >
          <ul>
            ...
            <li>
              <Link to="/foryou" onClick={() => setIsMobileMenuOpen(false)}>
                For You
              </Link>
            </li>
            <li className="dropdown">
              <Link to="/jewelry" onClick={() => setIsMobileMenuOpen(false)}>
              ...
              <div className="dropdown-content">
                ...
                <Link
                  to="/jewelry?category=Necklace"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Necklaces
                </Link>
                <Link
                  to="/jewelry?category=Pendant"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Pendants
                </Link>
                <Link
                  to="/jewelry?category=Ring"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Rings
                </Link>
            ...
            {/* Show user-specific icons only for authenticated users - MOBILE ONLY */}
            {isAuthenticated && (
              <div className="mobile-only">
                <li>
                  <Link
            ...
            {isAuthenticated && (
              <div className="mobile-only">
                ...
                <Link to="/auctions" onClick={() => setIsMobileMenuOpen(false)}>
                  Auctions
                </Link>
                <Link to="/bids" onClick={() => setIsMobileMenuOpen(false)}>
                  My Bids
                </Link>
              </div>
            )}
        ...
        {/* Actions group for desktop */}
        <div className="navbar-actions-group desktop-only">
          {isAuthenticated && (
            <>
              <Link
                to="/notifications"
