      ...
      setLikesCount((prevCount) => {
        ...
        try {
          localStorage.setItem(
            likeKey,
            JSON.stringify({ liked: next, count: nextCount })
          );
        } catch (e) {}
        return nextCount;
      });
    ...
    <div className="bids-page">
      ...
      <div className="bids-container">
        ...
        <div className="bids-header">
          <h1 className="bids-title">
            One Gram Gold Polki Guttapusalu Necklace Set By Asp Fashion
            Jewellery
          </h1>
          <button
        ...
        <div className="bids-grid">
          ...
          <div className="bids-left-section">
            ...
            <section className="about-box">
              ...
              <h3>
                One Gram Gold Guttapusalu Necklace set By Asp Fashion Jewellery
              </h3>
              <p>
                This beautiful 24 Ct gold plated Plated Guttapusalu Necklace has
                made of the highest quality metalwork and embroidered with
                Polki, dazzling Ruby & Emerald Kempu stones. With a pair of
                exquisite earrings to match, it's perfect for any occasion, be
                it a friend's party or a traditional wedding gala.
              </p>
            </section>
          </div>
          ...
          <aside className="bids-sidebar">
            ...
            <div className="bid-box">
              ...
              <div className="bidder-row">
                <div className="bidder-avatar" aria-hidden>
                  DP
                </div>
                <div className="bidder-text">
                  Selected by Duwindu piyumika Sanduneth ▸
                </div>
              </div>
              ...
              <div className="bid-history">
                <div className="history-row">
                  <span>Bidder -32814</span>
                  <span>3 day ago</span>
                  <span>$1040</span>
                </div>
                <div className="history-row">
                  <span>Bidder -72854</span>
                  <span>1 day ago</span>
                  <span>$1065</span>
                </div>
                <div className="history-row">
                  <span>Bidder -42814</span>
                  <span>2 day ago</span>
                  <span>$1055</span>
                </div>
                <div className="history-row">
