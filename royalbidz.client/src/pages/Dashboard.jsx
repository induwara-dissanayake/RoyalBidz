...
const Dashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      setStats({
        auctions: {
          total: auctionsRes.data.items
            ? auctionsRes.data.items.length
            : auctionsRes.data.length,
      ...
      {!isAuthenticated && (
        <div className="card">
          <div style={{ textAlign: "center", padding: "20px" }}>
            ...
            >
              Join our exclusive auction platform to bid on luxury jewelry from
              around the world. Create an account to start participating in
              auctions and building your collection.
            </p>
            <div
              style={{
                display: "flex",
        ...
        {recentAuctions.length === 0 ? (
          ...
          <div className="grid grid-2">
            {recentAuctions.map((auction) => {
              const statusText =
                auction?.status != null ? String(auction.status) : "Unknown";
